...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date = ('2017-01-04' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2017-01-04';
		self::$version_name = ('Eyas' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Eyas';
	}
}
