...
/**
* Kunena Component
* @package Kunena.Template.JA_Playstore
*
...
class KunenaTemplateJA_playstore extends KunenaTemplate {
	// Try to find missing files from the following parent templates:
	protected $default = array('ja_playstore');
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_ja_playstore');
		...
		$filename = JPATH_SITE . '/components/com_kunena/template/ja_playstore/css/custom.css';
